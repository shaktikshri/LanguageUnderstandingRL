...
NUM_RUNS = 20
NUM_EPOCHS = 200
NUM_EPIS_TRAIN = 30  # number of episodes for training at each epoch
...
def run_episode(for_training, need_history=False):
    ...
    while not terminal:
        ...
        action_index, object_index = epsilon_greedy(state_1=dict_room_desc[current_room_desc],
        ...
        history.append([current_room_desc, current_quest_desc, action_index, object_index, next_room_desc,
                        next_quest_desc, reward, terminal])

        if for_training:
            # update Q-function.
            tabular_q_learning(q_func=q_func,
